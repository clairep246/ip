...
public class Bags { 
    ...
    // Stores the actual Task objects used by the program. 
    ...
    public static void main(String[] args) { 
        ...
        //Save one final time before exiting the program.
        saveTasks();
    ...
    /**Load task when chatbot is started
     * store in reading file and parsed into Task objects using parseTask helper
     * **/
     ...
     * Since both store and readingFile indexes the task at the same index, removing both will remove the same task 
     * 
     */ 
    ...
    /** 
     * Repeatedly echoes the user's input until "exit" is entered. 
     */ 
